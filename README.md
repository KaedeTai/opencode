...
- **WebSocket** — `opencode websocket`. A multi-session WS bridge (default `:9999/ws`) for custom frontends. Replaces the old `packages/websocket/` sidecar.
...
# WebSocket bridge for a custom frontend
